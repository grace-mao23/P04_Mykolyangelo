...
from app.graphql.models import CO2Emission
...
class CO2EmissionQuery(graphene.ObjectType):
    ...
    co2_emission_by_code = graphene.List(lambda: CO2Emission, code=graphene.Int())

    all_co2_emission_by_year = graphene.List(lambda: CO2Emission, year=graphene.Int())
